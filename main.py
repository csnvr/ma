...
class ScreenWelcome(Screen):
    ...
    def welcome_button(self):
        ...
        if valid:
            ...
            st_invalid_pn = 1
            self.ids.info_text.text = f'Please insert valid phone number'
...
class ScreenMain(Screen):
    ...
    def check(self):
        ...
        if end_type == 'X' and not popup:
            ...
            self.dialog = MDDialog(title='Congrats X!' if gamemode == 'coop' else 'Congrats!', text='You are the winner!', size_hint=(1, 1),
